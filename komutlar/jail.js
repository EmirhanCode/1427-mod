...
module.exports.run = async(client,message,args) => {
    ...
    let oziemb = new Discord.MessageEmbed()
        ...
        let cezarolu = osettings.jailhammer || "jailhammerid" // id girilecek buraya da :) eğer proje benim projem değilse
        let boosterrolu = osettings.boosterrolu || "boosterrolüid" // Proje hazır değilse id gelicek .)
        let jailrolu = osettings.jailrolu || "jailroluid" // Buraya da aynı şekilde 
        let jlog = message.guild.channels.cache.get(osettings.cezalog) || message.guild.channels.cache.get("logkanalid") // kanal id girilebilir
