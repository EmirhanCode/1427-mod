...
//Id girilicek yerler
let mlog = await message.guild.channels.cache.get(osettings.cezalog) || message.guild.channels.cache.get("mutelogid") 
let cezarolu = osettings.mutehammer || "mutehammerid"
let mrol = osettings.muterolu || "muterolüid"
...
exports.help = {
  ...
  usage: '.mute id/@etiket 1sn/1dk/1sa/1g sebep'
}
